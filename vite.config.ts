  ...
  plugins: [
    ...
    federation({
      ...
      remotes: {
        ...
        remoteGame1: cacheBustedRemote('https://olesiatk.github.io/leoday-remote-game1/assets/remoteEntry.js'),
        remoteGame2: cacheBustedRemote('https://olesiatk.github.io/leoday-remote-game2/assets/remoteEntry.js'),
        remoteGame3: cacheBustedRemote('https://olesiatk.github.io/leoday-remote-game3/assets/remoteEntry.js'),
      },
